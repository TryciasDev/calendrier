<div class="jumbotron jumbotron-fluid text-center">
	<?php if ($mode=='update'): ?>
		  ...
		  <h1>Mon Profil <?= ($datas[0]->identifiant) ?> ...</h1>
    ...
    <?php else: ?>
		  <h1><?= ($datas[0]->identifiant) ?>, tu souhaites qu'un ami nous rejoigne ? Inscrit le</h1>
...
<div class="container-fluid">
	...
	<form method="Post" action="/MonProfil/<?= ($datas[0]->identifiant) ?>" id="formulaire">
...
<?php endif; ?>
		<div class="form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" readonly class="form-control-plaintext" name="Pseudo" id="staticPseudo" value="<?= ($datas[0]->identifiant) ?>">
		    </div>
		  </div>		
		<div class="form-group row">
		    <label for="Nom" class="col-sm-2 col-form-label">Nom</label>
		    <div class="col-sm-10">
		      <input type="text" readonly class="form-control-plaintext" name="Nom" id="Nom" value="<?= ($datas[0]->Nom) ?>">
		    </div>
		  </div>
		<div class="form-group row">
		    <label for="Prenom" class="col-sm-2 col-form-label">Prénom</label>
		    <div class="col-sm-10">
		      <input type="text" readonly class="form-control-plaintext" name="Prenom" id="Prenom" value="<?= ($datas[0]->Prenom) ?>">
		    </div>
		  </div>
		<div class="form-group row">
		    <label for="Email" class="col-sm-2 col-form-label">Email</label>
		    <div class="col-sm-10">
		      <input type="text" readonly class="form-control-plaintext" name="email" id="Email" value="<?= ($datas[0]->email) ?>">
		    </div>
		  </div>
	<?php if ($mode=='update'): ?>
			  ...
			  <div class="form-group">
			    ...
			    <textarea class="form-control form-control-plaintext" id="conditions" name="Conditions" rows="3" maxlength="250"><?= ($datas[0]->Conditions) ?></textarea>
			  </div>
